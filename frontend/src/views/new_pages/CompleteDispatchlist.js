...
export default class CompleteDispatchList extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            columns: [
                ...
                {
                    title: "實際開工日", field: "real_start_date"
                },
                {
                    title: "實際完工日", field: "real_end_date"
                },
                {
                ...
                {
                    title: "狀態", field: "status", render: (data) => {
                        return '已完工'
                    }
                },
                {
                    title: "編輯", field: "id", render: (ele) => {
                        // console.log(ele)
                        return (<a href={`/admin/finish_dispatch?id=${ele.id}&status=finish`}><Button>查看詳細</Button></a>)
                    }
                },
            ],
            data: []
    ...
    do_something = async () => {
        let dispatchlist = await request.get_dispatch_by_status(2)
